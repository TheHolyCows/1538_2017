...
{	
	...
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_LEFT_ENCODER, 0, 0, 0, true, 0.5));
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 70, 0, 0.5, true, 1.25));
	...
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 80, 98, 0.55, false, 1));
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 80, 98, 0.375, true, 0.5));
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_HOLD_DISTANCE, 70, 90, 0.5, true, 0.5));
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_SHOOT, 70, 90, 0.5, true, 15));
