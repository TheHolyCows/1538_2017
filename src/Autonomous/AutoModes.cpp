...
{	
	...
	m_Modes["Gear N Shoot - Right"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 65, -128, 0.55, false, 1));
	m_Modes["Gear N Shoot - Right"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 50, -128, 0.375, true, 1));
	...
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 65, 128, 0.55, false, 1));
	m_Modes["Gear N Shoot - Left"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 50, 128, 0.375, true, 1));
